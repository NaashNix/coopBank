...
public class RationLoanPayModel {
    ...
    public RationLoanPayModel(String LoanNumber, String accountNumber, int NumberOfInstallments, double LoanPaidAmount, Date nextInstallmentDate, double loanAmount, double installmentValue, int numOfInstallmentsTobePaid) {
