...
public class ViewDepositTransactionController {
    ...
    public AnchorPane depositContext;

    public void cancelButtonOnAction(ActionEvent actionEvent) throws IOException {
        URL resource = getClass().getResource("../view/ViewAllCustomersForm.fxml");
        Parent load = FXMLLoader.load(resource);
        depositContext.getStylesheets().clear();
        depositContext.getChildren().clear();
        depositContext.getChildren().add(load);
    }
